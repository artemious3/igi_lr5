...
from .views import AddServiceView, OrderServiceDeleteView, OrderNewView, OrderServiceUpdateView, client_index, orders_approved_view, orders_unapproved_view, order_submit_view
...
urlpatterns = [
        ...
        path('orders/<int:pk>/delete/', OrderServiceDeleteView.as_view(), name='order_delete'),
